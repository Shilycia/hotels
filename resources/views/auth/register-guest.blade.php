...
<head>
    ...
    <title>Daftar Akun – {{ config('hotel.name', 'Hotel Neo') }}</title>
    ...
    <style>
        ...
        .auth-brand { display:flex; align-items:center; gap:10px; margin-bottom:36px; text-decoration:none; z-index: 1; }
        ...
        .auth-center-icon { width:72px; height:72px; border-radius:50%; background:rgba(200,169,110,.1); border:1px solid rgba(200,169,110,.2); display:flex; align-items:center; justify-content:center; margin-bottom:18px; }
        .auth-center-icon i { font-size:28px; color:#c8a96e; opacity:.85; }
        ...
        .auth-perks li::before { content:''; width:5px; height:5px; border-radius:50%; background:#c8a96e; opacity:.75; flex-shrink:0; }
        ...
        .auth-section-tag { font-size:10.5px; font-weight:600; color:#c8a96e; text-transform:uppercase; letter-spacing:1.2px; margin-bottom:5px; }
        ...
        .text-warning { color: #c8a96e !important; }
...
<div class="bg-dark py-2 px-4 d-none d-lg-flex align-items-center justify-content-between">
    <small class="text-white-50"><i class="fa fa-phone-alt text-primary me-2" style="font-size:11px; color: #c8a96e !important;"></i>{{ config('hotel.phone', '+62 812 3456 7890') }}</small>
    <small class="text-white-50"><i class="far fa-clock text-primary me-2" style="font-size:11px; color: #c8a96e !important;"></i>{{ config('hotel.hours', 'Layanan 24 Jam') }}</small>
</div>
    ...
    <div class="auth-card">
        ...
        <div class="auth-left">
            ...
            <div class="auth-illus">
                ...
                <div class="auth-headline">Bergabung dengan<br>Hotel Neo</div>
                <div class="auth-desc">Buat akun Anda dan nikmati berbagai keuntungan eksklusif.</div>
                <ul class="auth-perks">
                    <li>Harga khusus member</li>
                    <li>Pemesanan cepat & mudah</li>
                    <li>Kelola semua reservasi</li>
                    <li>Prioritas layanan bantuan</li>
                    <li>Penawaran spesial</li>
                </ul>
            </div>
        </div>
        ...
        <div class="auth-right">
            ...
            <div class="auth-section-tag">Akun Baru</div>
            <div class="auth-title">Buat Akun</div>
            <div class="auth-subtitle">Daftar sekarang untuk kemudahan pemesanan dan penawaran khusus.</div>
            ...
            <form method="POST" action="{{ route('guest.register.submit') }}" id="registerForm">
                ...
                <div class="form-row-2 mb-3">
                    ...
                    <div>
                        <label class="auth-label" for="phone">Nomor Telepon <span class="text-muted fw-normal" style="text-transform:none;letter-spacing:0">(Opsional)</span></label>
                        <div class="auth-input-group">
                ...
                <div class="form-row-2 mb-3">
                    ...
                    <div>
                        <label class="auth-label" for="password_confirmation">Konfirmasi Sandi</label>
                        <div class="auth-input-group">
                            <div class="ig-icon"><i class="fa fa-lock"></i></div>
                        ...
                        <div class="field-error d-none" id="matchError">Kata sandi tidak cocok.</div>
                    </div>
                </div>
                ...
                <div class="form-check mb-4">
                    ...
                    <label class="form-check-label small text-muted" for="terms">
                        Saya menyetujui <a href="#" class="text-warning text-decoration-none">Syarat & Ketentuan</a>
                        serta <a href="#" class="text-warning text-decoration-none">Kebijakan Privasi</a>
                    </label>
                </div>

                {{-- Submit --}}
                <button type="submit" class="btn btn-primary w-100 py-3 fw-semibold text-white" id="registerBtn">
                    <span id="registerLabel"><i class="fa fa-user-plus me-2"></i>Daftar Sekarang</span>
                    <span class="spinner-border spinner-border-sm d-none" id="registerSpinner" role="status"></span>
                </button>
            </form>

            <div class="auth-divider"><span>sudah memiliki akun?</span></div>

            <a href="{{ route('guest.login') }}" class="btn btn-outline-secondary w-100 py-2" style="font-size:13.5px">
                <i class="fa fa-sign-in-alt me-2"></i>Masuk ke Akun
            </a>
        </div>
...
<script>
    ...
    pwInput.addEventListener('input', function () {
        ...
        const levels = [
            { w:'25%', bg:'#dc3545', t:'Lemah' },
            { w:'50%', bg:'#fd7e14', t:'Cukup' },
            { w:'75%', bg:'#ffc107', t:'Baik' },
            { w:'100%',bg:'#28a745', t:'Kuat' },
        ];
