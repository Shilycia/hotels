    ...
    <div class="row gx-0">
        ...
        <div class="col-lg-5 px-5 text-end">
            ...
            <div class="h-100 d-inline-flex align-items-center">
                <a class="btn btn-sm-square bg-white text-primary me-1" href="{{ config('hotel.facebook', '#') }}">
                    <i class="fab fa-facebook-f"></i>
                </a>
                <a class="btn btn-sm-square bg-white text-primary me-1" href="{{ config('hotel.twitter', '#') }}">
                    <i class="fab fa-twitter"></i>
                </a>
                <a class="btn btn-sm-square bg-white text-primary me-1" href="{{ config('hotel.linkedin', '#') }}">
                    <i class="fab fa-linkedin-in"></i>
                </a>
                <a class="btn btn-sm-square bg-white text-primary me-0" href="{{ config('hotel.instagram', '#') }}">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto py-4 py-lg-0">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle {{ request()->routeIs('team') || request()->routeIs('testimonial') ? 'active' : '' }}"
        ...
        <a href="{{ route('booking') }}" class="btn btn-primary rounded-0 py-4 px-lg-5 d-none d-lg-block">
            Book A Room <i class="fa fa-arrow-right ms-3"></i>
        </a>
    </div>
</nav>