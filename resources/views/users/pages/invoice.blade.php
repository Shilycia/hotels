                    ...
                    @if($payment->payment_status === 'pending')
                        ...
                        @else
                            <div class="alert alert-warning text-center">
                                <i class="fa fa-exclamation-triangle me-2"></i> Token pembayaran tidak tersedia. Silakan muat ulang halaman.
                            </div>
                        @endif
                    @else
...
@if($payment->payment_status === 'pending' && isset($snapToken) && $snapToken)
@push('scripts')
