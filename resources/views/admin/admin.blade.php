...
<head>
    ...
    <title>@yield('title') – Hotel Neo</title>
    ...
    <style>
        /* ─── CSS Variables & Styling (Biarkan persis seperti aslinya) ─── */
        :root {
        --bg:         #f0f2f8;
        --surface:    #ffffff;
        --sidebar-bg: #0f172a;
        ...
        *,::before,::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .page{display:none;padding:2rem;animation:fadeIn .3s ease}
        ...
        .section-title{font-family:'Fraunces',serif;font-size:1.5rem;font-weight:700;color:var(--text-dark)}
        .section-desc{font-size:.82rem;color:var(--text-light);margin-top:.2rem}
        ...
        .chart-period-tabs{display:flex;gap:.25rem}
        .period-tab{ padding:.3rem .7rem;border-radius:var(--radius-sm);font-size:.72rem;font-weight:500; cursor:pointer;border:none;background:transparent;color:var(--text-light); transition:all var(--transition); }
        .period-tab.active{background:var(--blue-soft);color:var(--blue);font-weight:600}
        ...
        .coming-soon{ display:flex;flex-direction:column;align-items:center;justify-content:center; min-height:60vh;text-align:center;gap:1.25rem; }
        .donut-legend{display:flex;flex-direction:column;gap:.6rem;margin-top:1.25rem}
        .legend-item{display:flex;align-items:center;gap:.6rem;font-size:.78rem;color:var(--text-mid)}
    ...
    <div class="main">
        <div class="topbar">
            <div>
                ...
                <div class="topbar-sub">Kelola data sistem Hotel Neo</div>
            </div>
        </div>
