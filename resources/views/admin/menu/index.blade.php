                    ...
                    <td>
                        <div class="menu-cell">
                            ...
                            <div>
                                ...
                                <span style="font-size:11px;color:var(--ink3)">{{ \Illuminate\Support\Str::limit($menu->description, 30) ?? '-' }}</span>
                            </div>
                        </div>
                    </td>
                    ...
                    <td style="text-align:center">
                        <div style="display:flex;gap:5px;justify-content:center">
                            <button class="btn btn-outline btn-sm"
                                    onclick="openEditModal('{{ $menu->id }}','{{ addslashes($menu->name) }}','{{ $menu->price }}','{{ addslashes($menu->description) }}', '{{ $menu->category }}', '{{ $menu->is_available ? 1 : 0 }}')">
...
<script>
    ...
    function openEditModal(id, name, price, description, category, is_available) {
